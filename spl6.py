...
def launch_smart_grid(pkg, uri, index=0, total=1):
    ...
    # 4. Ambil Task ID lalu terapkan ukuran resize sesuai koordinat grid cerdas
    task_id = get_task_id(pkg)
    if task_id:
        print(f"-> Task ID ditemukan ({task_id}), menerapkan ukuran grid...")
...
if __name__ == "__main__":
    ...
    # Sesuaikan parameter 'index' dan 'total' jika ingin membagi layar untuk banyak akun sekaligus
